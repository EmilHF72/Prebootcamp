#Mini prueba input - output
#tu_nombre = input('¿Cómo te llamas?') #La entrada toma un prompt que debe ser una cadena
#print(f'¡Hola {tu_nombre}! Ya aprendiste de entradas y salidas') #Salida. Imprime el nombre dado en consola
